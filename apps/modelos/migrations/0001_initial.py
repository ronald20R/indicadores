...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('total_casos_resueltos', models.IntegerField(default=0)),
                ('total_casos_ingresados', models.IntegerField(default=0)),
                ('total_casos_en_tramite', models.IntegerField(default=0)),
                ('dependencia', models.CharField(max_length=256)),
                ('total_sentencias', models.IntegerField(default=0)),
                ('total_archivos_consentidos', models.IntegerField(default=0)),
                ('total_archivo_califica', models.IntegerField(default=0)),
                ('total_archivo_preliminar', models.IntegerField(default=0)),
                ('fecha_creacion', models.DateField(auto_now_add=True)),
                ('fecha_modificacion', models.DateField(auto_now=True)),
            ],
        ),
